...
```
  ...
  <change>
    <file>src/lib/libraryModels.ts</file>
    <description>Update SavedProject interface: remove mockup fields, add pricingStrategy field.</description>
    <content><![CDATA[import type { AnalyzeMarketOutput } from "@/ai/flows/analyze-market-flow";
